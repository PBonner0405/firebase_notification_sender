  ...
  for(let i = 1 ; i < 2 ; i ++) {
    await admin.messaging().sendMulticast({
      tokens: [
        ...
        'eqVM7UJ6a5eHacTPTzISqj:APA91bF2Vh494ItAd7yxHFWdTgmxVHLwVVM_1qJYexgHyWXR1xYh_xHYekmEIBCOzu_M4uGu-73YdZMDOjncmtnCwjJ32jWVn4CqLdjSdbih9mmxP_L49ehBmMHfq7s52BC2U8jaNWum'
      ],
      data: {
